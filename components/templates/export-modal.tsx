  ...
  const handleExport = async () => {
    ...
    try {
      ...
      switch (selectedFormat) {
        case "json":
          successFlag = exportAsJson(canvas, "JSON FileName") || false;

          break;

        case "png":
          successFlag = exportAsPng(canvas, "PNG FileName") || false;

          break;

        case "svg":
          successFlag = exportAsSVG(canvas, "SVG FileName") || false;

          break;

        case "pdf":
          successFlag = exportAsPDF(canvas, "PDF FileName") || false;
